...
import kotlinx.android.synthetic.main.activity_fragact.*
import java.util.*

class MainFragmentActivity : FragmentActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val menu = findViewById<ListView>(R.id.menu)
        //        准备数据源
        lists = ArrayList()
        ...
        adapter = SimpleAdapter(this@MainFragmentActivity, lists, R.layout.list_item, arrayOf("image", "content", "cacheSize"), intArrayOf(R.id.image, R.id.content, R.id.cacheSize))
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.llHome -> {
                ...
                reside_layout.isSlideable = false
            }
            R.id.llLesson -> {
            ...
            R.id.llMe -> {
                ...
                reside_layout.isSlideable = true
            }
            R.id.llFind -> {
